 ...
 */
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Start.prefWidthProperty().bind(anchorpane1.widthProperty());
        Start.prefHeightProperty().bind(anchorpane1.heightProperty());
        Clear.prefHeightProperty().bind(anchorpane1.heightProperty());
                choiceBox.prefHeightProperty().bind(anchorpane1.heightProperty());
        GridSizey.prefHeightProperty().bind(anchorpane1.heightProperty());
                GridSizex.prefHeightProperty().bind(anchorpane1.heightProperty());
        Clear.pr
